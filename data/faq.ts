...
export interface FaqSectionContent {
  title: string;
  intro: string;
  support: { heading: string; body: string; ctaLabel: string; ctaAppPath: string };
  entries: FaqEntry[];
}
...
export const faqSection: FaqSectionContent = {
  ...
  intro:
    "Everything about how ApplyHustle works, what's included, and how we keep your data safe. Filter by topic or browse them all.",
  support: {
    heading: 'Still have questions?',
    body: 'Create a free account and explore every feature — no credit card needed.',
