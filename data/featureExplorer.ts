  ...
  tabs: [
    {
      ...
      icon: Target,
      label: 'ATS Score',
      blurb: 'Score & fix your résumé per job.',
      url: 'app.applyhustle.com/ats-score',
    },
    {
      id: 'resume',
      icon: FileText,
      label: 'Resume Redesign',
      blurb: 'Rewrite to 95+ in one click.',
      url: 'app.applyhustle.com/resume',
    },
    {
      id: 'jobs',
      icon: Briefcase,
      label: 'Job Feed',
      blurb: 'Sponsorship-aware openings.',
      url: 'app.applyhustle.com/jobs',
    },
    {
      id: 'interview',
      icon: Mic,
      label: 'Mock Interview',
      blurb: 'STAR-scored practice.',
      url: 'app.applyhustle.com/interview',
    },
    {
      id: 'linkedin',
      icon: LinkedInGlyph,
      label: 'LinkedIn',
      blurb: 'Gap analysis & fixes.',
      url: 'app.applyhustle.com/linkedin',
    },
    {
      id: 'auto',
      icon: Send,
      label: 'Auto-Apply',
      blurb: 'Apply at volume (US Premium).',
      url: 'app.applyhustle.com/auto-apply',
    },
  ],
};
